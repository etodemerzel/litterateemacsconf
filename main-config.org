...
**** python
     :LOGBOOK:
     CLOCK: [2016-02-03 Ср 16:11]--[2016-02-03 Ср 16:19] =>  0:08
     :END:

     [2016-02-03 Ср 16:10]

     По умолчанию, устанавливаем ipython консоль
...
***** jedi direx
      :LOGBOOK:
      CLOCK: [2016-02-03 Ср 15:51]--[2016-02-03 Ср 15:53] =>  0:02
      :END:

      расширение для навигации по пайтон проекту
...
***** jedi
      :LOGBOOK:
      CLOCK: [2016-02-03 Ср 15:36]--[2016-02-03 Ср 15:44] =>  0:08
      :END:

      [2016-02-03 Ср 15:43]
      система автодополнения для питона
      ...
      Так как джедай использует пакет epc, устанавливаем и его
****** epc
       :LOGBOOK:
       CLOCK: [2016-02-03 Ср 15:44]--[2016-02-03 Ср 15:51] =>  0:07
       :END:
...
***** ein
      :LOGBOOK:
      CLOCK: [2016-02-03 Ср 16:19]
      :END:

      [2016-02-03 Ср 16:19]

      ein -- emacs ipython notebook. Как можно понять из названия, что то вроде записной книжки, записями в которой служат полезные программы на питоне. Например записная книжка научных вычислений + графики, ну и всё в таком роде.
      [[https://github.com/tkf/emacs-ipython-notebook][Гит]].
      [[https://github.com/tkf/emacs-ipython-notebook/wiki/Screenshots][Сборник скриншотов с примерами творчества]].
      ...
      Для того чтобы начать пользоваться ein'ом необходимо

      1. Запустить ipython notebook(набрав это в консоле)
      2. M-x: ein:notebooklist-open
      3. открыть подходящий блокнот
...
**** yasnippet
     ...
     #+BEGIN_SRC elisp :tangle ~/.emacs
       ...
       (require 'yasnippet)
       (yas-global-mode 1)
       ;;[2016-01-04 Пн 10:05] указание на папку со сниппетами
...
*** org-ref
    ...
    [2016-01-07 Чт 18:31]
    Пакет org-ref наконец-то был добавлен в MELPA
...
*** ox-twbs
    ...
    [2016-01-22 Пт 05:10]
    Средство улучшения экспорта из org в html. [[http://irreal.org/blog/?p=4899][Из заметки]].
    ...
    Чтобы воспользоваться экспортом с помощью этого расширения, необходимо будучи в нужно буфере орг-документа вызвать из командной строки emacs функцию org-twbs-export-to-html.
** iedit-mode
...
*** avy-menu
    :LOGBOOK:
    CLOCK: [2016-02-02 Вт 14:34]--[2016-02-02 Вт 14:37] =>  0:03
    :END:

    [2016-02-02 Вт 14:36]
    Всплывающее меню для ави. [[https://github.com/mrkkrp/avy-menu][Репозиторий]].
...
** COMMENT elscreen
   :LOGBOOK:
   CLOCK: [2016-02-03 Ср 13:47]--[2016-02-03 Ср 16:11] =>  2:24
   :END:

   [2016-02-02 Вт 16:18]

   Расширение, позволяющее создавать вкладки для emacs
   #+begin_src elisp :tangle ~/.emacs
   ...
   [2016-02-03 Ср 13:48]
   Отключу пока. С переключением между фреймами и буферами, кажется вторчным и ненужным.
...
*** COMMENT Cyberpunk+оранжевый курсор
...
*** COMMENT darcula + org-beautify-theme
    ...
    #+END_SRC
*** COMMENT org-beautify
    :LOGBOOK:
    CLOCK: [2016-01-04 Пн 10:36]--[2016-01-04 Пн 10:37] =>  0:01
    :END:
...
*** moe-theme
    :LOGBOOK:
    CLOCK: [2016-01-04 Пн 10:12]--[2016-01-04 Пн 10:16] =>  0:04
    CLOCK: [2016-01-04 Пн 10:05]--[2016-01-04 Пн 10:10] =>  0:05
    :END:

    [2016-01-04 Пн 10:06]
    Так как с новыми монитором старая тема стала просто вырви-глаз, решил переключится на менее контрастную и более "пастельную" тему.
