...
**** символы свёртки
     :LOGBOOK:
     CLOCK: [2015-11-05 Чт 00:01]
     :END:

     [2015-11-05 Чт 00:01]
     Символ свёртки в имакс это символ, обозначающий что под данной строкой скрываются данные, которые можно увидеть воспользовавшись клавишей TAB
     #+begin_src elisp :tangle ~/.emacs
       (setq org-ellipsis "↴")
     #+end_src
